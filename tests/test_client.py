...
def _response(location: str) -> httpx.Response:
...
def test_a_redirect_within_the_endpoint_is_left_to_the_caller() -> None:
    _reject_gateway(_response("https://monitoring.example/web/"))


def test_a_relative_redirect_is_left_to_the_caller() -> None:
